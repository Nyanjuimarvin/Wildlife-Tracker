...
class UnthreatenedAnimalTest {
    ...
    public UnthreatenedAnimal setUp(){
    ...
    public void UnthreatenedAnimal_InstantiatesCorrectly_True(){
        animal = setUp();
    ...
    public void UnthreatenedAnimal_InstantiatesWithProperties_True(){
        animal = setUp();
    ...
    public void UnthreatenedAnimal_InstantiatesWithId_True(){
        animal = setUp();
    ...
    public void UnthreatenedAnimals_CheckObjectEquality_True(){
        animal = setUp();
        animal.saveAnimal();
    ...
    public void find_FindsAnimalsAtGivenId_UnthreatenedAnimal(){
        animal = setUp();
        animal.saveAnimal();
